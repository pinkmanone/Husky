package com.husky.library.swipe;
...
//        mCircleView.layout(childLeft,mCurrentTargetOffsetTop,childLeft + circleWidth,mCurrentTargetOffsetTop + circleHeight); // 进度圈在左边
    }
...
//            System.out.println("nested pre scroll");
...
//        System.out.println("nested scroll stop");
        stopNestedScroll();
//        if (mTarget != null) {
